...
UA = function(configuration) {
  var events = [
    ...
    'mediaPermissionsAccept',
    'mediaPermissionsRefuse'
  ];
...
window.oktellVoice = (function() {
  ...
  JsSIPAccount = (function(_super) {
    ...
    JsSIPAccount.prototype.isOnHold = function() {
      ...
      return (_ref = this.holdedSession) != null ? typeof _ref.isOnHold === "function" ? _ref.isOnHold() : void 0 : void 0;
    };

    JsSIPAccount.prototype.resume = function() {
      var _ref;
      JsSIPAccount.__super__.resume.apply(this, arguments);
      return (_ref = this.holdedSession) != null ? typeof _ref.unhold === "function" ? _ref.unhold() : void 0 : void 0;
    };
