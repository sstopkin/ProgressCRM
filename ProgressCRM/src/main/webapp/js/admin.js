...
function getUsersList() {
    $.ajax({
        ...
        success: function(data) {
            ...
            str += "<table class=\"table table-hover table-bordered\" style='margin-top:10px; margin-bottom:10px;' >";
            str += "<thead class='t-header'><tr>";
            str += "<th class=\"col-md-6\">Email</th>";
            str += "<th class=\"col-md-1\">Уровень</th>";
            str += "<th class=\"col-md-4\">Сумма баллов</th>";
            ...
            for (var j = 0; j < list.length; ++j) {
                ...
                str += list[j][1];
                str += "</td><td>";
                str += "<div class=\"col-md-12\"><div class='input-group'><input class=\"form-control\" type=\"text\" id=\"userPoints" + j + "\" value=\"" + list[j][0].points + "\">";
