...
public class NewsController {
    ...
    public boolean deleteNewsById(Session session, String token, String id) throws IsNotAuthenticatedException {
        if (token == null) {
            throw new IsNotAuthenticatedException();
        }
    ...
    public boolean editNewsById(Session session, String newsId, String token, String text, String header) throws IsNotAuthenticatedException {
        if (token == null) {
            throw new IsNotAuthenticatedException();
        }
        //FIXME add permission
